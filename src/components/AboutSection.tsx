...
const values = [
  { title: "Готовые шаблоны и примеры формулировок", description: "Анкеты для агрегаторов, примеры первого контакта, шаблоны самопрезентации — адаптируете под свой стиль и начинаете применять" },
      ...
      <div className="container mx-auto max-w-7xl relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            Курс для специалистов, которые хотят начать практику и рассказывать о своей работе этично — без агрессивных продаж, манипуляций и давления на клиентов.
          </p>
        </div>
