...
const testimonials = [
  ...
  {
    quote: "Вела практику как коуч без диплома. Боялась, что меня не возьмут в Alter. Курс дал пошаговый алгоритм подачи — прошла с первого раза. После курса я перестала воспринимать продвижение как навязчивые продажи и смогла спокойно рассказать о своей практике.",
    name: "Ольга, 48 лет",
